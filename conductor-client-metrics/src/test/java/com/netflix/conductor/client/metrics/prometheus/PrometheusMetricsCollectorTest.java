...
class PrometheusMetricsCollectorTest {
    ...
    void nullToEmptyReturnsEmptyForNull() {
        assertEquals("", PrometheusMetricsCollector.nullToEmpty(null));
    }

    @Test
    void nullToEmptyReturnsOriginalForNonNull() {
        assertEquals("hello", PrometheusMetricsCollector.nullToEmpty("hello"));
    }

    @Test
    void nullToEmptyReturnsEmptyStringAsIs() {
        assertEquals("", PrometheusMetricsCollector.nullToEmpty(""));
    }
    ...
    void exceptionLabelReturnsEmptyForNull() {
        assertEquals("", PrometheusMetricsCollector.exceptionLabel(null));
    }

    @Test
    void exceptionLabelReturnsSimpleClassName() {
        assertEquals("RuntimeException",
                PrometheusMetricsCollector.exceptionLabel(new RuntimeException()));
    }

    @Test
    void exceptionLabelReturnsDifferentExceptionTypes() {
        assertEquals("IllegalStateException",
                PrometheusMetricsCollector.exceptionLabel(new IllegalStateException()));
        assertEquals("NullPointerException",
                PrometheusMetricsCollector.exceptionLabel(new NullPointerException()));
    }
    ...
    void exceptionLabelUnwrapsExecutionException() {
        ...
        assertEquals("IllegalArgumentException",
                PrometheusMetricsCollector.exceptionLabel(wrapper));
    }
    ...
    void exceptionLabelDoesNotUnwrapNonWrapperExceptions() {
        ...
        assertEquals("IllegalStateException",
                PrometheusMetricsCollector.exceptionLabel(outer));
    }
    ...
    void exceptionLabelHandlesAnonymousExceptionClass() {
        ...
        String label = PrometheusMetricsCollector.exceptionLabel(anon);
        assertNotNull(label);
