...
```
=== Multi-Level Approval Chain Demo: Manager -> Director -> VP ===

Step 1: Registering task definitions...
  Registered: ...

Step 2: Registering workflow 'multi_level_approval'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [mla_finalize] Finalizing approved request...
  [mla_submit] Processing submission...

  Status: COMPLETED
  Output: {finalized=..., submitted=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"requestId": "REQ-001", "REQ-001": "requestor", "requestor": "alice", "alice": "sample-alice"}'
```
