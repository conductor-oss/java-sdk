...
A Java Conductor workflow example demonstrating GDPR Consent. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 607: GDPR Consent ===

Step 1: Registering task definitions...
  Registered: gdc_present_options, gdc_record_consent, gdc_update_systems, gdc_audit

Step 2: Registering workflow 'gdc_gdpr_consent'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [audit] Audit trail created ->
  [present] Consent options presented to
  [record] Consent recorded:
  [update] 4 downstream systems updated with consent preferences

  Status: COMPLETED
  Output: {auditTrailId=..., immutable=..., options=..., presentedAt=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"userId": "USR-GDPR01", "USR-GDPR01": "consents", "consents": {"key": "value"}}'
```
