...
A Java Conductor workflow example demonstrating Multi Factor Auth. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"username": "test", "password": "sample-password", "preferredMethod": "sample-preferredMethod"}'
