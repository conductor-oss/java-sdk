...
A Java Conductor workflow example demonstrating User Analytics. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 617: User Analytics ===

Step 1: Registering task definitions...
  Registered: uan_collect_events, uan_aggregate, uan_compute_metrics, uan_report

Step 2: Registering workflow 'uan_user_analytics'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [aggregate] Events aggregated by segment
  [report] Analytics dashboard updated
  [collect] Collected events for range:
  [metrics] Key metrics computed: DAU=8450, MAU=12340, retention=68.5%

  Status: COMPLETED
  Output: {aggregated=..., uniqueUsers=..., dashboardUrl=..., generatedAt=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"dateRange": "2025-01-15T10:00:00Z", "start": "sample-start", "2024-10-01": "sample-2024-10-01", "end": "sample-end", "segments": "sample-segments", "free": "sample-free", "pro": "sample-pro"}'
```
