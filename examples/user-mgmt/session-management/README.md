...
A Java Conductor workflow example demonstrating Session Management. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 610: Session Management ===

Step 1: Registering task definitions...
  Registered: ses_create, ses_validate, ses_refresh, ses_revoke

Step 2: Registering workflow 'ses_session_management'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {sessionId=..., token=..., expiresIn=..., refreshed=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"userId": "USR-SES001", "USR-SES001": "deviceInfo", "deviceInfo": {"key": "value"}}'
```
