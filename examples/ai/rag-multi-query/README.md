...
| `CONDUCTOR_OPENAI_API_KEY` | _(not set)_ | OpenAI API key. When set, ExpandQueriesWorker and GenerateAnswerWorker call gpt-4o-mini instead of using demo output |
