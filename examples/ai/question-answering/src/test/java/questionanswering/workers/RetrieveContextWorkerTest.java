...
class RetrieveContextWorkerTest {
    private final RetrieveContextWorker worker = new RetrieveContextWorker();
    @Test void taskDefName() { assertEquals("qas_retrieve_context", worker.getTaskDefName()); }
