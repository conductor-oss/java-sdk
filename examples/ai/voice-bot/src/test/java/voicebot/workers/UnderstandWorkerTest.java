...
class UnderstandWorkerTest {
    private final UnderstandWorker worker = new UnderstandWorker();
    @Test void taskDefName() { assertEquals("vb_understand", worker.getTaskDefName()); }
