...
/**
 * Worker that encodes a question into a fixed embedding vector for pgvector.
 *
 * In production this would call an embedding API (e.g. OpenAI text-embedding-3-small).
 * Here we return a deterministic fixed-length vector.
 */
public class PgvecEmbedWorker implements Worker {

    /** Fixed 8-dimensional embedding for deterministic behaviour. */
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [embed] Encoded query for pgvector");
