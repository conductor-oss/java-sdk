...
conductor workflow start \
  ...
  --version 1 \
  --input '{"userId": "TEST-001", "message": "test-value", "sessionId": "TEST-001"}'d like to request a refund for my last charge", "I'd like to request a refund for my last charge": "sessionId", "sessionId": "SES-CHAT-001", "SES-CHAT-001": "sample-SES-CHAT-001"}'
```
