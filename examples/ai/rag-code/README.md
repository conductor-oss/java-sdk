...
| `CONDUCTOR_OPENAI_API_KEY` | _(not set)_ | OpenAI API key. When set, EmbedCodeQueryWorker calls text-embedding-3-small and GenerateCodeAnswerWorker calls gpt-4o-mini instead of using demo output |
