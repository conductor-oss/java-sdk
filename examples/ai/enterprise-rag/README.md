...
- **With `CONDUCTOR_OPENAI_API_KEY`**: GenerateWorker calls OpenAI Chat Completions (gpt-4o-mini). RetrieveWorker is demo-only because it requires a real vector database.
