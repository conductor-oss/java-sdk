...
```
=== Example 152: RAPTOR RAG ===

Step 1: Registering task definitions...
  Registered: rp_chunk_docs, rp_leaf_summaries, rp_cluster_summaries, rp_tree_search, rp_generate

Step 2: Registering workflow 'raptor_rag_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [chunk_docs] [SIMULATED] Chunking document (
  [cluster_summaries] [SIMULATED] Clustering
  [generate] Answer (live OpenAI) using
  [leaf_summaries] [SIMULATED] Summarizing
  [tree_search] [SIMULATED] Searching tree for: \"" + preview + "\"

  Status: COMPLETED
  Output: {chunks=..., chunkCount=..., clusterSummaries=..., treeSummary=...}
...
| `CONDUCTOR_OPENAI_API_KEY` | _(not set)_ | OpenAI API key. When set, GenerateWorker calls gpt-4o-mini instead of using simulated output |
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"documentText": "Sample documentText", "retries, rate limiting, and event-driven automation.": "sample-retries, rate limiting, and event-driven automation.", "question": "sample-question"}'
```
