...
/**
 * Worker that encodes a question into a fixed embedding vector for Elasticsearch knn search.
 */
public class EsEmbedWorker implements Worker {

    // Fixed 8-dimensional embedding (deterministic, no randomness)
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [embed] Encoded query for Elasticsearch knn");
