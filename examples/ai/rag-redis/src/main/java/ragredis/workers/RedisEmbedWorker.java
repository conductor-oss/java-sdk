 ...
 * Uses deterministic values instead of a real embedding model.
 */
public class RedisEmbedWorker implements Worker {
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [embed] Query vectorized for Redis FT.SEARCH: " + question);
