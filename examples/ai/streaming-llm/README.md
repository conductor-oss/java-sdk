...
| `CONDUCTOR_OPENAI_API_KEY` | _(none)_ | OpenAI API key. When set, `StreamCollectChunksWorker` calls the real OpenAI streaming endpoint (SSE). When unset, returns demo chunked responses with `[DEMO]` prefix. |
