...
/**
 * Generates an answer from vector store context (the "relevant" branch).
 *
...
public class GenerateAnswerWorker implements Worker {
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [llm] Calling OpenAI to generate from " + source + " context...");
        try {
            String question = (String) task.getInputData().get("question");
            Object context = task.getInputData().get("context");
            String contextStr = context != null ? context.toString() : "";

            String systemPrompt = "You are a helpful assistant. Generate a concise answer based on the provided context documents.";
