...
```
=== Example 165: RAG with LangChain Integratio ===

Step 1: Registering task definitions...
  Registered: lc_load_documents, lc_split_text, lc_embed_chunks, lc_retrieve, lc_generate

Step 2: Registering workflow 'rag_langchain'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [embed_chunks] Generated
  [generate] Response from OpenAI API (LIVE)
  [load_documents] Loaded
  [retrieve] Retrieved
  [split_text] Split into

  Status: COMPLETED
  Output: {embeddings=..., embeddingCount=..., model=..., chunk=...}
