...
```
=== Example 630: Knowledge Base Sync ===

Step 1: Registering task definitions...
  Registered: kbs_crawl, kbs_extract, kbs_update, kbs_index, kbs_verify

Step 2: Registering workflow 'kbs_knowledge_base_sync'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [crawl] Crawled
  [extract] Extracted 89 articles from crawled pages
  [index] Search index rebuilt with
  [update] Knowledge base
  [verify] Search index verified -

  Status: COMPLETED
  Output: {pages=..., pageCount=..., articles=..., articleCount=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"sourceUrl": "https://docs.example.com", "https://docs.example.com": "kbId", "kbId": "KB-MAIN-001", "KB-MAIN-001": "sample-KB-MAIN-001"}'
```
...
- **IndexWorker** (`kbs_index`): connect to Elasticsearch, Algolia, or a vector database for production-grade search indexing
