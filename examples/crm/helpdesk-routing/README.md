...
```
=== Example 629: Helpdesk Routing ===

Step 1: Registering task definitions...
  Registered: hdr_classify, hdr_tier1, hdr_tier2, hdr_tier3

Step 2: Registering workflow 'hdr_helpdesk_routing'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [classify] Issue classified as
  [tier1] Basic support handling issue for
  [tier2] Technical support handling issue for
  [tier3] Senior engineering handling issue for

  Status: COMPLETED
  Output: {tier=..., confidence=..., keywords=..., handler=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"issueDescription": "API integration returning 500 errors on bulk requests", "API integration returning 500 errors on bulk requests": "customerId", "customerId": "CUST-HDR01", "CUST-HDR01": "sample-CUST-HDR01"}'
```
