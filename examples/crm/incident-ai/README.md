...
```
=== Example 650: Incident AI ===

Step 1: Registering task definitions...
  Registered: iai_detect, iai_diagnose, iai_suggest_fix, iai_execute_fix, iai_verify

Step 2: Registering workflow 'iai_incident_ai'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [detect] Alert
  [diagnose]
  [execute] Applying fix:
  [suggest] Fix:
  [verify] Verifying

  Status: COMPLETED
  Output: {incidentId=..., incidentDetails=..., diagnosis=..., fixApplied=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"alertId": "ALT-9921", "ALT-9921": "serviceName", "serviceName": "checkout-service", "checkout-service": "severity", "severity": "critical", "critical": "sample-critical"}'
```
