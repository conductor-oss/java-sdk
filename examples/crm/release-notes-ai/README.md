...
```
=== Example 643: Release Notes AI ===

Step 1: Registering task definitions...
  Registered: rna_collect_commits, rna_categorize, rna_generate_notes, rna_publish

Step 2: Registering workflow 'rna_release_notes'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [categorize] Features:
  [collect] Found
  [generate] Generated release notes with
  [publish] Published release notes for

  Status: COMPLETED
  Output: {features=..., fixes=..., docs=..., performance=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"repoName": "sample-name", "acme/backend": "sample-acme/backend", "fromTag": "sample-fromTag", "v2.3.0": "sample-v2.3.0", "toTag": "sample-toTag"}'
```
