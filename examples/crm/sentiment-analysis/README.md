...
```
=== Example 633: Sentiment Analysis ===

Step 1: Registering task definitions...
  Registered: snt_preprocess, snt_analyze, snt_classify, snt_aggregate

Step 2: Registering workflow 'snt_sentiment_analysis'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [aggregate] Overall:
  [analyze] Sentiment scores computed for
  [classify] Classifications:
  [preprocess] Cleaned

  Status: COMPLETED
  Output: {overallSentiment=..., distribution=..., source=..., sentiments=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"texts": "Sample texts", "Great product!": "sample-Great product!", "Terrible support": "sample-Terrible support", "source": "sample-source"}'
```
