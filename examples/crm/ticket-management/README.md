...
```
=== Example 628: Ticket Management ===

Step 1: Registering task definitions...
  Registered: tkt_create, tkt_classify, tkt_assign, tkt_resolve, tkt_close

Step 2: Registering workflow 'tkt_ticket_management'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {assignee=..., slaHours=..., category=..., priority=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"subject": "sample-subject", "Cannot login after password reset": "sample-Cannot login after password reset", "description": "sample-description", "Users cannot login after resetting password - urgent fix needed": "sample-Users cannot login after resetting password - urgent fix needed", "reportedBy": "sample-reportedBy"}'
```
