...
```
=== Example 626: Webinar Registratio ===

Step 1: Registering task definitions...
  Registered: wbr_register, wbr_confirm, wbr_remind, wbr_followup

Step 2: Registering workflow 'wbr_webinar_registration'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [followup] Post-webinar follow-up sent with recording link
  [register]
  [remind] Reminder sent: 24h and 1h before event

  Status: COMPLETED
  Output: {confirmed=..., calendarInvite=..., sent=..., content=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"attendeeName": "Jack Torres", "Jack Torres": "email", "email": "jack@company.com", "jack@company.com": "webinarId", "webinarId": "WEB-AI-2024", "WEB-AI-2024": "sample-WEB-AI-2024"}'
```
