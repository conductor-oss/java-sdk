...
```
=== Example 631: Chatbot Orchestratio ===

Step 1: Registering task definitions...
  Registered: cbo_receive, cbo_understand_intent, cbo_generate_response, cbo_deliver

Step 2: Registering workflow 'cbo_chatbot_orchestration'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [deliver] Response delivered to
  [generate] Response generated for intent:
  [receive] Message from
  [intent] Detected intent:

  Status: COMPLETED
  Output: {delivered=..., channel=..., latencyMs=..., response=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"userId": "USR-CHAT01", "USR-CHAT01": "message", "message": "I'd like to request a refund for my last charge", "I'd like to request a refund for my last charge": "sessionId", "sessionId": "SES-CHAT-001", "SES-CHAT-001": "sample-SES-CHAT-001"}'
```
