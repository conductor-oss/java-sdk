...
```
=== Example 644: API Test Generatio ===

Step 1: Registering task definitions...
  Registered: atg_parse_spec, atg_generate_tests, atg_run_tests, atg_report

Step 2: Registering workflow 'atg_api_test_generation'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {testSuite=..., testCount=..., endpoints=..., endpointCount=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"specUrl": "https://api.example.com/resource", "https://api.example.com/openapi.json": "sample-https://api.example.com/openapi.json", "format": "sample-format"}'
```
