...
```
=== Example 632: Voice Bot ===

Step 1: Registering task definitions...
  Registered: vb_transcribe, vb_understand, vb_generate, vb_synthesize

Step 2: Registering workflow 'vb_voice_bot'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [synthesize] Speech synthesized ->
  [transcribe] Audio transcribed: \"" + transcript + "\"
  [understand] Intent: order_status, Entity: order#1234

  Status: COMPLETED
  Output: {responseText=..., tokensUsed=..., audioUrl=..., durationSec=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"audioUrl": "https://calls.example.com/recording-632.wav", "https://calls.example.com/recording-632.wav": "callerId", "callerId": "+1-555-0199", "+1-555-0199": "language", "language": "en-US", "en-US": "sample-en-US"}'
```
