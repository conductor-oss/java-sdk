...
```
=== Example 634: Text Classificatio ===

Step 1: Registering task definitions...
  Registered: txc_preprocess, txc_extract_features, txc_classify, txc_confidence

Step 2: Registering workflow 'txc_text_classification'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [classify] Predicted category: technology
  [confidence] Confidence:
  [features] Extracted
  [preprocess] Text cleaned (

  Status: COMPLETED
  Output: {prediction=..., scores=..., confidence=..., margin=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"text": "Sample text", "Researchers developed a new deep neural network for NLU": "sample-Researchers developed a new deep neural network for NLU", "categories": "sample-categories", "technology": "sample-technology", "science": "sample-science", "business": "sample-business"}'
```
...
- **ClassifyWorker** (`txc_classify`): swap in a fine-tuned BERT classifier or LLM for production-grade text classification
