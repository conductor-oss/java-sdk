...
```
=== Example 642: Bug Triage ===

Step 1: Registering task definitions...
  Registered: btg_parse_report, btg_classify_severity, btg_handle_critical, btg_handle_high, btg_handle_low, btg_assign

Step 2: Registering workflow 'btg_bug_triage'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [high] Flagging
  [low] Adding
  [parse] Parsed bug report: \"" + title + "\"

  Status: COMPLETED
  Output: {assignee=..., priority=..., severity=..., handled=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"bugReport": "sample-bugReport", "title": "sample-title", "App crash on login with SSO": "sample-App crash on login with SSO", "description": "sample-description", "Application crash when users attempt SSO login with expired tokens": "sample-Application crash when users attempt SSO login with expired tokens", "component": "sample-component"}'
```
