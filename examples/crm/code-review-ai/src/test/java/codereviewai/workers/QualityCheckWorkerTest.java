...
class QualityCheckWorkerTest {
    private final QualityCheckWorker worker = new QualityCheckWorker();
    @Test void taskDefName() { assertEquals("cra_quality_check", worker.getTaskDefName()); }
