...
```
=== Example 640: AI Code Review ===

Step 1: Registering task definitions...
  Registered: cra_parse_diff, cra_security_check, cra_quality_check, cra_style_check, cra_report

Step 2: Registering workflow 'cra_code_review_ai'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [parse] Diff parsed from
  [quality] Code quality analysis: 2 issues found
  [report] Review complete:
  [security] Security analysis: 1 issue found
  [style] Style analysis: 3 issues found

  Status: COMPLETED
  Output: {files=..., linesChanged=..., hunks=..., findings=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"prUrl": "https://api.example.com/resource", "https://github.com/example/repo/pull/42": "sample-https://github.com/example/repo/pull/42", "diff": "sample-diff"}'
```
