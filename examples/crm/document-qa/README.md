...
```
=== Example 638: Document QA ===

Step 1: Registering task definitions...
  Registered: dqa_ingest, dqa_chunk, dqa_index, dqa_query, dqa_answer

Step 2: Registering workflow 'dqa_document_qa'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [chunk] Document split into 42 chunks
  [index] Vector index created ->
  [ingest] Document ingested from
  [query] Top 3 relevant chunks retrieved

  Status: COMPLETED
  Output: {answer=..., confidence=..., sourceChunks=..., chunks=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"documentUrl": "https://api.example.com/resource", "https://docs.example.com/earnings-q4.pdf": "sample-https://docs.example.com/earnings-q4.pdf", "question": "sample-question"}'
```
...
- **IndexWorker** (`dqa_index`): connect to a vector database (Pinecone, Weaviate, pgvector) for production-grade semantic search
