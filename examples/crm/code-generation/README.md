...
```
=== Example 639: Code Generatio ===

Step 1: Registering task definitions...
  Registered: cdg_parse_requirements, cdg_generate_code, cdg_validate, cdg_test

Step 2: Registering workflow 'cdg_code_generation'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [generate] Code generated in
  [parse] Requirements parsed:
  [test]
  [validate] Syntax check passed, no lint errors

  Status: COMPLETED
  Output: {code=..., linesOfCode=..., testCases=..., filesGenerated=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"requirements": "sample-requirements", "Build a REST API with user management": "sample-Build a REST API with user management", "language": "sample-language", "javascript": "sample-javascript", "framework": "sample-framework"}'
```
