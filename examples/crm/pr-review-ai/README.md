...
```
=== Example 647: PR Review AI ===

Step 1: Registering task definitions...
  Registered: prr_fetch_diff, prr_analyze_changes, prr_generate_review, prr_post_review

Step 2: Registering workflow 'prr_pr_review'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [fetch] PR #
  [review] Verdict:
  [post] Posted review on PR #

  Status: COMPLETED
  Output: {analysis=..., issueCount=..., diff=..., filesChanged=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"repoName": "sample-name", "acme/backend": "sample-acme/backend", "prNumber": 5}'
```
