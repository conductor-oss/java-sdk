...
Step 1: Registering task definitions...
  Registered: oo_buffer_events, oo_sort_events, oo_process_next

Step 2: Registering workflow 'event_ordering'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [oo_buffer_events] Buffering
  [oo_process_next] Processing event at index
  [oo_sort_events] Sorting buffered events by seq field

  Status: COMPLETED
  Output: {buffered=..., count=..., processedSeq=..., iteration=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"events": "sample-events", "seq": "sample-seq", "type": "standard", "update": "2025-01-15T10:00:00Z", "data": "sample-data", "create": "sample-create", "modify": "sample-modify"}'
```
