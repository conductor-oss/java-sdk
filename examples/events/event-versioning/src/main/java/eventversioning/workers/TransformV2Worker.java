 ...
 * Input: event (map)
 * Output: transformed (event merged with version:"v3", migratedFrom:"v2")
 */
public class TransformV2Worker implements Worker {

    @Override
    public String getTaskDefName() {
        return "vr_transform_v2";
    }
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [vr_transform_v2] Converting v2 event to v3 format");

        Map<String, Object> transformed = new HashMap<>(event);
        transformed.put("version", "v3");
        transformed.put("migratedFrom", "v2");
