...
SQS Consumer .  receive an SQS message, validate it, process the event, and delete the message from the queue. Uses [Conductor](https://github.## The Problem
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"queueUrl": "https://example.com", "messageId": "TEST-001", "receiptHandle": "test-value", "body": "test-value"}'
```
