...
Step 1: Registering task definitions...
  Registered: wt_process_event, wt_validate_payload, wt_transform_data, wt_store_result

Step 2: Registering workflow 'webhook_trigger_wf'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [wt_process_event] Processing event:
  [wt_store_result] Storing record to
  [wt_transform_data] Transforming data to
  [wt_validate_payload] Validating

  Status: COMPLETED
  Output: {eventType=..., parsedData=..., schema=..., receivedAt=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"eventType": "order.created", "order.created": "payload", "payload": {"key": "value"}, "shopify-webhook": "timestamp", "timestamp": "2026-03-08T10:00:00Z", "2026-03-08T10:00:00Z": "sample-2026-03-08T10:00:00Z"}'
```
