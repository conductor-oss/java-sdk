...
/**
 * Emits an order event to the event bus.
 * Input: eventType, orderId
 * Output: emitted (true), eventType
 */
public class EmitOrderEventWorker implements Worker {

    @Override
    public String getTaskDefName() {
        return "ch_emit_order_event";
    }
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [ch_emit_order_event] Event: " + eventType + " for " + orderId);
