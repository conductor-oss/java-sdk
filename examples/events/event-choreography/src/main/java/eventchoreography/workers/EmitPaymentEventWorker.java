...
/**
 * Emits a payment event to the event bus.
 * Input: eventType, orderId
 * Output: emitted (true), eventType
 */
public class EmitPaymentEventWorker implements Worker {

    @Override
    public String getTaskDefName() {
        return "ch_emit_payment_event";
    }
    ...
    public TaskResult execute(Task task) {
        ...
        System.out.println("  [ch_emit_payment_event] Event: " + eventType + " for " + orderId);
