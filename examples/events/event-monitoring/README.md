...
Sequential event monitoring workflow that collects metrics, analyzes throughput, latency, and errors, then generates a report. ## The Problem
...
Each monitoring concern is a simple, independent worker. a plain Java class that does one thing. Conductor takes care of collecting metrics, analyzing them for anomalies, and generating the report, retrying if a metrics API times out, tracking every monitoring run, and providing a complete history of pipeline health assessments. ### What You Write: Workers
