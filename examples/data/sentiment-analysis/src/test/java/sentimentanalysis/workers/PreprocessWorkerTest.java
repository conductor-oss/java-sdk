...
class PreprocessWorkerTest {
    private final PreprocessWorker worker = new PreprocessWorker();
    @Test void taskDefName() { assertEquals("snt_preprocess", worker.getTaskDefName()); }
