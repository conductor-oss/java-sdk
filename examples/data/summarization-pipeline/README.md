...
conductor workflow start \
  ...
  --version 1 \
  --input '{"document": "sample-document", "maxLength": "sample-maxLength"}'
...
- **GenerateSummaryWorker** (`sum_generate_summary`): swap in an LLM with explicit length constraints for example-grade summary generation
