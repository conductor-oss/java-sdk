...
class ExtractSectionsWorkerTest {
    private final ExtractSectionsWorker worker = new ExtractSectionsWorker();
    @Test void taskDefName() { assertEquals("sum_extract_sections", worker.getTaskDefName()); }
