...
class ConfidenceWorkerTest {
    private final ConfidenceWorker worker = new ConfidenceWorker();
    @Test void taskDefName() { assertEquals("txc_confidence", worker.getTaskDefName()); }
