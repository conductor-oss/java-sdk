...
Replace the demo compressor with real zstd, LZ4, or Snappy via Apache Commons Compress, add SHA-256 checksum verification, and the compression pipeline runs unchanged.
