...
Automates on-demand feature environment provisioning using [Conductor](https://github.com/conductor-oss/conductor). This workflow provisions an isolated Kubernetes namespace for a feature branch, deploys the branch code, configures a preview DNS URL, and posts the preview link back to the pull request. You write the provisioning logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 360: Feature Environment ===

Step 1: Registering task definitions...
  Registered: fe_provision, fe_deploy_branch, fe_configure_dns, fe_notify

Step 2: Registering workflow 'feature_environment_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [dns] Preview URL configured
  [deploy] Deployed branch to preview environment
  [notify] Posted preview link to PR
  [provision] Created namespace for branch feature-auth-v2
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"branch": "sample-branch", "feature-auth-v2": "sample-feature-auth-v2", "repository": "sample-repository"}'
```
