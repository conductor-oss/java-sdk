...
A Java Conductor workflow example demonstrating Donor Management. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"donorName": "test", "donorEmail": "user@example.com", "firstGift": "sample-firstGift"}'
