...
A Java Conductor workflow example demonstrating Beneficiary Tracking. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .## The Problem
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"beneficiaryName": "test", "programId": "TEST-001", "location": "test-value"}'
```
