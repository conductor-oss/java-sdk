...
| `CONDUCTOR_OPENAI_API_KEY` | _(none)_ | OpenAI API key for live AI guardrails (optional. falls back to demo) |
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"userPrompt": "What is workflow orchestration?", "userId": "TEST-001", "modelId": "TEST-001"}'
