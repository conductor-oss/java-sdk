...
| `CONDUCTOR_OPENAI_API_KEY` | _(none)_ | OpenAI API key for live script and storyboard generation (optional. falls back to demo) |
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"topic": "microservices best practices", "duration": "sample-duration", "style": "sample-style"}'
