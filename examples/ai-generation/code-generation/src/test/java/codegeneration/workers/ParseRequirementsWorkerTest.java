...
class ParseRequirementsWorkerTest {
    private final ParseRequirementsWorker worker = new ParseRequirementsWorker();
    @Test void taskDefName() { assertEquals("cdg_parse_requirements", worker.getTaskDefName()); }
