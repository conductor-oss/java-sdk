...
class StyleCheckWorkerTest {
    private final StyleCheckWorker worker = new StyleCheckWorker();
    @Test void taskDefName() { assertEquals("cra_style_check", worker.getTaskDefName()); }
