...
| `ELASTICSEARCH_URL` | _(none)_ | Elasticsearch cluster URL (e.g., `http://localhost:9200`). Currently unused, all workers run in demo mode with `` output prefix. Swap in Elasticsearch Java client for production. |
