...
```
=== Example 444: Database Integratio ===

Step 1: Registering task definitions...
  Registered: dbi_connect, dbi_query, dbi_transform, dbi_write, dbi_verify

Step 2: Registering workflow 'database_integration_444'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {sourceConnectionId=..., targetConnectionId=..., rows=..., rowCount=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"sourceDb": "sample-sourceDb", "postgres://source:5432/users": "sample-postgres://source:5432/users", "targetDb": "sample-targetDb", "postgres://target:5432/users_v2": "sample-postgres://target:5432/users-v2", "query": "sample-query", "SELECT * FROM users WHERE status = 'active'": "pending", "transformRules": "sample-transformRules", "uppercase_name": "sample-name"}'
```
