...
conductor workflow start \
  ...
  --version 1 \
  --input '{"sourceDb": "test-value", "targetDb": "test-value", "query": "test-value", "transformRules": "test-value"}'active'": "pending", "transformRules": "sample-transformRules", "uppercase_name": "sample-name"}'
```
