...
A Java Conductor workflow example demonstrating Legal Case Management. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"clientId": "TEST-001", "caseType": "standard", "description": "sample-description"}'
