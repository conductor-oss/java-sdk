...
class FileWorkerTest {
    @Test void taskDefName() { assertEquals("ptf_file", new FileWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new FileWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("applicationNumber"));
    }
}
