...
A Java Conductor workflow example demonstrating Patent Filing. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"inventionTitle": "sample-inventionTitle", "inventors": "sample-inventors", "description": "sample-description"}'
