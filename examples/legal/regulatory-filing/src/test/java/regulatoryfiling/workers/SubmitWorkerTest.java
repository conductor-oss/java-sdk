...
class SubmitWorkerTest {
    @Test void taskDefName() { assertEquals("rgf_submit", new SubmitWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new SubmitWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("submissionId"));
    }
}
