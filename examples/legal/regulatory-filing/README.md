...
A Java Conductor workflow example demonstrating Regulatory Filing. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"filingType": "standard", "entityName": "test", "jurisdiction": "sample-jurisdiction"}'
