...
class NotifyWorkerTest {
    @Test void taskDefName() { assertEquals("lth_notify", new NotifyWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new NotifyWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("notifiedCount"));
    }
}
