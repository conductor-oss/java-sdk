...
class ReviewWorkerTest {
    @Test void taskDefName() { assertEquals("lgb_review", new ReviewWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new ReviewWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("approvedHours"));
    }
}
