...
class TrackTimeWorkerTest {
    @Test void taskDefName() { assertEquals("lgb_track_time", new TrackTimeWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new TrackTimeWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("totalHours"));
    }
}
