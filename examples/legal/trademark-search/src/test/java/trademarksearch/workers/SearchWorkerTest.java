...
class SearchWorkerTest {
    @Test void taskDefName() { assertEquals("tmk_search", new SearchWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new SearchWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("totalResults"));
    }
}
