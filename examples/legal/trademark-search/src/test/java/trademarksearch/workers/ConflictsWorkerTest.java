...
class ConflictsWorkerTest {
    @Test void taskDefName() { assertEquals("tmk_conflicts", new ConflictsWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new ConflictsWorker().execute(t);
        assertEquals(TaskResult.Status.COMPLETED, r.getStatus());
        assertNotNull(r.getOutputData().get("conflictCount"));
    }
}
