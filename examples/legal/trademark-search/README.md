...
A Java Conductor workflow example demonstrating Trademark Search. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .## The Problem
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"trademarkName": "test", "goodsAndServices": "test-value"}'
```
