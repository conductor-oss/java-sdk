...
A Java Conductor workflow example demonstrating Trademark Search. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Trademark Search Demo ===

Step 1: Registering task definitions...
  Registered: tmk_assess, tmk_conflicts, tmk_recommend, tmk_search

Step 2: Registering workflow 'trademark_search'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [assess] Assessing trademark risk
  [conflicts] Analyzing conflicts from search results
  [recommend] Generating recommendation for:
  [search] Searching trademark databases for:

  Status: COMPLETED
  Output: {assessment=..., riskLevel=..., conflicts=..., conflictCount=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"trademarkName": "AcmeBrand", "AcmeBrand": "goodsAndServices", "goodsAndServices": "Software development tools", "Software development tools": "sample-Software development tools"}'
```
