...
class CalculateDutyWorkerTest {
    @Test void taskDefName() { assertEquals("cst_calculate_duty", new CalculateDutyWorker().getTaskDefName()); }
    @Test void completes() {
        ...
        TaskResult r = new CalculateDutyWorker().execute(t);
