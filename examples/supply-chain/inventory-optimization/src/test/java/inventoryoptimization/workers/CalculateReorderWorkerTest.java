...
class CalculateReorderWorkerTest {
    @Test void taskDefName() { assertEquals("io_calculate_reorder", new CalculateReorderWorker().getTaskDefName()); }
    @Test void completesSuccessfully() {
        ...
        TaskResult r = new CalculateReorderWorker().execute(t);
