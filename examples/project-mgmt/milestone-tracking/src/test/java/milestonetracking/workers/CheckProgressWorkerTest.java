...
class CheckProgressWorkerTest {
    private final CheckProgressWorker w = new CheckProgressWorker();
    @Test void taskDefName() { assertEquals("mst_check_progress", w.getTaskDefName()); }
    @Test void executes() {
