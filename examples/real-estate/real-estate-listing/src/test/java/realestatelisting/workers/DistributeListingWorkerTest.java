...
class DistributeListingWorkerTest {
    @Test void taskDefName() { assertEquals("rel_distribute", new DistributeListingWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new DistributeListingWorker().execute(t);
