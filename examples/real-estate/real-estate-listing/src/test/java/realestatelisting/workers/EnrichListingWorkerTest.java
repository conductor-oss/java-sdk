...
class EnrichListingWorkerTest {
    @Test void taskDefName() { assertEquals("rel_enrich", new EnrichListingWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new EnrichListingWorker().execute(t);
