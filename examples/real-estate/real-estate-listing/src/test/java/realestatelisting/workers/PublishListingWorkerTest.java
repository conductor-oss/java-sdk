...
class PublishListingWorkerTest {
    @Test void taskDefName() { assertEquals("rel_publish", new PublishListingWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new PublishListingWorker().execute(t);
