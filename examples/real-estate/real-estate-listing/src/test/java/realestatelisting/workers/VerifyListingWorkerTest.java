...
class VerifyListingWorkerTest {
    @Test void taskDefName() { assertEquals("rel_verify", new VerifyListingWorker().getTaskDefName()); }
    @Test void executes() {
        ...
        TaskResult r = new VerifyListingWorker().execute(t);
