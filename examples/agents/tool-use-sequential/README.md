...
Tool Use Sequential: search the web, read a page, extract data, and summarize through a sequential pipeline of simulated tool calls. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers ,  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
Step 1: Registering task definitions...
  Registered: ts_search_web, ts_read_page, ts_extract_data, ts_summarize

Step 2: Registering workflow 'tool_use_sequential'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [ts_extract_data] Extracting data for query:
  [ts_read_page] Reading page:
  [ts_search_web] Searching for:
  [ts_summarize] Summarizing data for query:

  Status: COMPLETED
  Output: {data=..., relevanceScore=..., content=..., statusCode=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"query": "sample-query", "What is Conductor workflow orchestration?": "sample-What is Conductor workflow orchestration?", "maxResults": "sample-maxResults"}'
```
