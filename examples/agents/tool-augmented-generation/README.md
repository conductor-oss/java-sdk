...
Tool-Augmented Generation .  detect knowledge gaps during text generation, invoke external tools to fill them, and produce enriched output. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers ,  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
Step 1: Registering task definitions...
  Registered: tg_start_generation, tg_detect_gap, tg_call_tool, tg_incorporate_result, tg_complete_generation

Step 2: Registering workflow 'tool_augmented_generation'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [tg_call_tool] Calling tool '
  [tg_complete_generation] Completing generation for prompt:
  [tg_detect_gap] Detecting gap in partial text (type=
  [tg_incorporate_result] Incorporating tool result into partial text
  [tg_start_generation] Generating partial text for prompt:

  Status: COMPLETED
  Output: {toolResult=..., source=..., cached=..., finalText=...}
