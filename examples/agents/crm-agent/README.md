...
CRM Agent. lookup customer, check history, update record, and generate response through a sequential pipeline. ## Personalized Responses Require Full Customer Context
