...
Calendar Agent .  parse meeting request, check attendee calendars, find available slots, and book the meeting through a sequential pipeline. Uses [Conductor](https://github.
