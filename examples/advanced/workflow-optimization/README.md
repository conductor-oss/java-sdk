...
A Java Conductor workflow example for workflow optimization .  analyzing execution history to measure task durations, identifying wasted time (sequential tasks that could run in parallel, unnecessary waits), recommending parallelization opportunities, and benchmarking the optimized version against the original. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers ,  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
Step 1: Registering task definitions...
  Registered: wfo_analyze_execution, wfo_identify_waste, wfo_parallelize, wfo_benchmark

Step 2: Registering workflow 'wfo_workflow_optimization'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {dependencyGraph=..., taskTimings=..., originalOrder=..., totalDurationMs=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"workflowName": "sample-name"}'
```
