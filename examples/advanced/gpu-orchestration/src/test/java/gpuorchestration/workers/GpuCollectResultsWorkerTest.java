...
class GpuCollectResultsWorkerTest {

    private final GpuCollectResultsWorker worker = new GpuCollectResultsWorker();

    @Test
    void taskDefName() {
        assertEquals("gpu_collect_results", worker.getTaskDefName());
    }
