...
class TprClassifyPriorityWorkerTest {

    private final TprClassifyPriorityWorker worker = new TprClassifyPriorityWorker();

    @Test
    void taskDefName() {
        assertEquals("tpr_classify_priority", worker.getTaskDefName());
    }
