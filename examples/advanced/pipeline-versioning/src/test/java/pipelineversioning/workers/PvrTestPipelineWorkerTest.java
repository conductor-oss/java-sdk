...
class PvrTestPipelineWorkerTest {

    private final PvrTestPipelineWorker worker = new PvrTestPipelineWorker();

    @Test
    void taskDefName() {
        assertEquals("pvr_test_pipeline", worker.getTaskDefName());
    }
