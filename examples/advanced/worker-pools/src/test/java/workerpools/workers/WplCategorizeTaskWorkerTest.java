...
class WplCategorizeTaskWorkerTest {

    private final WplCategorizeTaskWorker worker = new WplCategorizeTaskWorker();

    @Test
    void taskDefName() {
        assertEquals("wpl_categorize_task", worker.getTaskDefName());
    }
