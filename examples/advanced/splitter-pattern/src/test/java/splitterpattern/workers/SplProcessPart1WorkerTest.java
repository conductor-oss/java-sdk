...
class SplProcessPart1WorkerTest {

    private final SplProcessPart1Worker worker = new SplProcessPart1Worker();

    @Test
    void taskDefName() {
        assertEquals("spl_process_part_1", worker.getTaskDefName());
    }
