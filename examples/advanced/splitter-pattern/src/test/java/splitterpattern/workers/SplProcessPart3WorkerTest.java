...
class SplProcessPart3WorkerTest {

    private final SplProcessPart3Worker worker = new SplProcessPart3Worker();

    @Test
    void taskDefName() {
        assertEquals("spl_process_part_3", worker.getTaskDefName());
    }
