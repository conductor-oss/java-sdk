...
class SplProcessPart2WorkerTest {

    private final SplProcessPart2Worker worker = new SplProcessPart2Worker();

    @Test
    void taskDefName() {
        assertEquals("spl_process_part_2", worker.getTaskDefName());
    }
