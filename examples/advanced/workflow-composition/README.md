...
Each worker implements one step of a sub-workflow. replace the demo payment and inventory calls with real Stripe and warehouse APIs and the composed order pipeline runs unchanged.
