...
class WiProcessStandardWorkerTest {

    private final WiProcessStandardWorker worker = new WiProcessStandardWorker();

    @Test
    void taskDefName() {
        assertEquals("wi_process_standard", worker.getTaskDefName());
    }
