...
Step 1: Registering task definitions...
  Registered: wi_init, wi_validate, wi_process_standard, wi_process_premium, wi_finalize

Step 2: Registering workflow 'workflow_inheritance_standard_demo'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [finalize] Processing
  [init] Processing
  [process-premium] Processing
  [process-standard] Processing
  [validate] Processing

  Status: COMPLETED
  Output: {finalized=..., initialized=..., result=..., sla=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"requestId": "REQ-STD-1", "REQ-STD-1": "data", "data": "standard_payload", "standard_payload": "sample-standard-payload"}'
```
...
- **WiProcessStandardWorker** (`wi_process_standard`): implement real tier-specific processing: standard database queries for free tier, dedicated Redis cache lookups for premium, or custom ML inference for enterprise
