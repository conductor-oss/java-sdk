...
A Java Conductor workflow example for the pipeline pattern .  passing raw data through a series of sequential processing stages where each stage transforms the data and passes its output to the next. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers ,  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
Step 1: Registering task definitions...
  Registered: pip_stage_1, pip_stage_2, pip_stage_3, pip_stage_4

Step 2: Registering workflow 'pip_pipeline_pattern'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [stage-1: validate] Processing
  [stage-2: transform] Processing
  [stage-3: enrich] Processing
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"rawData": {"key": "value"}, "PL-2024-001": "sample-PL-2024-001"}'
```
