...
class HybProcessCloudWorkerTest {

    private final HybProcessCloudWorker worker = new HybProcessCloudWorker();

    @Test
    void taskDefName() {
        assertEquals("hyb_process_cloud", worker.getTaskDefName());
    }
