...
class HybClassifyDataWorkerTest {

    private final HybClassifyDataWorker worker = new HybClassifyDataWorker();

    @Test
    void taskDefName() {
        assertEquals("hyb_classify_data", worker.getTaskDefName());
    }
