...
class HybProcessOnpremWorkerTest {

    private final HybProcessOnpremWorker worker = new HybProcessOnpremWorker();

    @Test
    void taskDefName() {
        assertEquals("hyb_process_onprem", worker.getTaskDefName());
    }
