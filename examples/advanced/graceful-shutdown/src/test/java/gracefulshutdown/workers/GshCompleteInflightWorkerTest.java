...
class GshCompleteInflightWorkerTest {

    private final GshCompleteInflightWorker worker = new GshCompleteInflightWorker();

    @Test
    void taskDefName() {
        assertEquals("gsh_complete_inflight", worker.getTaskDefName());
    }
