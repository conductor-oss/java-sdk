...
Step 1: Registering task definitions...
  Registered: npt_request, npt_validate, npt_coordinate, npt_port, npt_verify

Step 2: Registering workflow 'npt_number_porting'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {portDate=..., windowStart=..., windowEnd=..., ported=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"phoneNumber": 5, "+1-555-0172": "sample-+1-555-0172", "fromCarrier": "sample-fromCarrier", "CarrierA": "sample-CarrierA", "toCarrier": "sample-toCarrier"}'
```
