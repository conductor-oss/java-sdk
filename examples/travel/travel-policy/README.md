...
Travel policy with SWITCH for compliant/exception. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 537: Travel Policy ===

Step 1: Registering task definitions...
  Registered: tpl_check, tpl_compliant, tpl_exception, tpl_process

Step 2: Registering workflow 'tpl_travel_policy'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [compliant]
  [exception]
  [process] Booking processed for

  Status: COMPLETED
  Output: {complianceResult=..., reason=..., autoApproved=..., exceptionApproved=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"employeeId": "EMP-1000", "EMP-1000": "bookingType", "bookingType": "hotel", "hotel": "amount", "amount": 500, "standard": "sample-standard"}'
```
