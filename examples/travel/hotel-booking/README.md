...
Hotel booking: search, filter, book, confirm, reminder. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
```
=== Example 541: Hotel Booking ===

Step 1: Registering task definitions...
  Registered: htl_search, htl_filter, htl_book, htl_confirm, htl_reminder

Step 2: Registering workflow 'htl_hotel_booking'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [book] Hotel reserved for
  [confirm] Reservation
  [filter] Filtered hotels by policy compliance
  [reminder] Check-in reminder scheduled for
  [search] Searching hotels in

  Status: COMPLETED
  Output: {reservationId=..., confirmationCode=..., confirmed=..., bestMatch=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"travelerId": "TRV-400", "TRV-400": "city", "city": "New York", "New York": "checkIn", "checkIn": "2024-04-15", "2024-04-15": "checkOut", "checkOut": "2024-04-18", "2024-04-18": "sample-2024-04-18"}'
```
