...
class AvailabilityWorkerTest {
    private final AvailabilityWorker w = new AvailabilityWorker();
    @Test void taskDefName() { assertEquals("ivs_availability", w.getTaskDefName()); }
    @Test void executes() {
