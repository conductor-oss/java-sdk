...
```
=== Example 356: DevSecOps Pipeline ===

Step 1: Registering task definitions...
  Registered: dso_sast_scan, dso_sca_scan, dso_container_scan, dso_security_gate

Step 2: Registering workflow 'devsecops_pipeline_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [container] Image scan: 0 critical vulnerabilities
  [sast] Static analysis: 0 critical, 2 medium
  [sca] Dependency scan: 0 critical, 1 high vulnerability
  [gate] Security gate PASSED .  no critical findings
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"repository": "sample-repository", "payment-service": "sample-payment-service", "commitSha": "sample-commitSha"}'
```
