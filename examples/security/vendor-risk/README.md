...
```
=== Example 362: Vendor Risk ===

Step 1: Registering task definitions...
  Registered: vr_collect_questionnaire, vr_assess_risk, vr_review_soc2, vr_make_decision

Step 2: Registering workflow 'vendor_risk_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [risk] Risk score: 72/100 .  medium risk, data encryption gaps identified
  [questionnaire] CloudAnalytics Inc: security questionnaire completed
  [decision] Approved with conditions: require encryption at rest
  [soc2] SOC 2 Type II report valid, no qualifications
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"vendorName": "sample-name", "CloudAnalytics Inc": "sample-CloudAnalytics Inc", "dataAccess": "sample-dataAccess"}'
```
