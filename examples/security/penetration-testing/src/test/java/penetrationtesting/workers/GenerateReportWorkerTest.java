...
class GenerateReportWorkerTest {
    ...
    @Test
    void taskDefName() {
        assertEquals("pen_generate_report", worker.getTaskDefName());
    }

    @Test
    void generatesReportWithExploitData() {
        Task task = taskWith(Map.of("generate_reportData", Map.of("exploit_test", true)));
