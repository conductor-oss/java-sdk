...
class LoadConfigWorkerTest {
    private final LoadConfigWorker worker = new LoadConfigWorker();

    @Test void taskDefName() { assertEquals("cf_load_config", worker.getTaskDefName()); }
