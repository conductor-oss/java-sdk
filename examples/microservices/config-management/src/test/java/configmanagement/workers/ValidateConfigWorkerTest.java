...
class ValidateConfigWorkerTest {
    private final ValidateConfigWorker worker = new ValidateConfigWorker();

    @Test void taskDefName() { assertEquals("cf_validate_config", worker.getTaskDefName()); }
