...
class VerifyRotationWorkerTest {
    private final VerifyRotationWorker worker = new VerifyRotationWorker();

    @Test void taskDefName() { assertEquals("sr_verify_rotation", worker.getTaskDefName()); }
