...
class GenerateSecretWorkerTest {
    private final GenerateSecretWorker worker = new GenerateSecretWorker();

    @Test void taskDefName() { assertEquals("sr_generate_secret", worker.getTaskDefName()); }
