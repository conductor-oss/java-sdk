...
class UpdateServicesWorkerTest {
    private final UpdateServicesWorker worker = new UpdateServicesWorker();

    @Test void taskDefName() { assertEquals("sr_update_services", worker.getTaskDefName()); }
