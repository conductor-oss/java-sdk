...
Orchestrates blue-green deployment: deploy to green, validate, switch traffic, and monitor. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"serviceName": "test", "newVersion": "1.0", "imageTag": "sample-imageTag"}'
