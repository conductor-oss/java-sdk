...
```
=== Example 527: User Generated Content ===

Step 1: Registering task definitions...
  Registered: ugc_submit, ugc_moderate, ugc_approve, ugc_enrich, ugc_publish

Step 2: Registering workflow 'user_generated_content_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  Status: COMPLETED
  Output: {approvalMethod=..., approvedAt=..., metadata=..., autoTags=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"submissionId": "UGC-527-001", "UGC-527-001": "userId", "userId": "USER-5270", "USER-5270": "contentType", "contentType": "review", "review": "contentBody", "contentBody": "Conductor has transformed how we build our microservices. Highly recommended!", "Conductor has transformed how we build our microservices. Highly recommended!": "title", "title": "Amazing Workflow Platform", "Amazing Workflow Platform": "sample-Amazing Workflow Platform"}'
```
