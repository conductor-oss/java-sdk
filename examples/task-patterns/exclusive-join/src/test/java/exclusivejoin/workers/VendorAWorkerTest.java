...
class VendorAWorkerTest {

    private final VendorAWorker worker = new VendorAWorker();

    @Test
    void taskDefName() {
        assertEquals("ej_vendor_a", worker.getTaskDefName());
    }

    @Test
    void returnsVendorAResult() {
        ...
        assertEquals("A", vendorResult.get("vendor"));
        assertEquals(59.99, vendorResult.get("price"));
        assertEquals(250, vendorResult.get("responseTime"));
