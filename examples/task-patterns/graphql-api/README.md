...
GraphQL API demo. single task workflow to demonstrate REST vs GraphQL query patterns. Uses [Conductor](https://github.
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"project": "sample-project", "env": "staging"}'
