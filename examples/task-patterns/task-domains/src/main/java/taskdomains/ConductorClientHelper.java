...
public class ConductorClientHelper {
    ...
    /**
     * Start workers with a specific task-to-domain mapping.
     * Workers will only poll for tasks tagged with their assigned domain.
     */
    public void startWorkers(List<Worker> workers, Map<String, String> taskToDomain) {
        configurer = new TaskRunnerConfigurer.Builder(taskClient, workers)
                .withThreadCount(workers.size())
                .withSleepWhenRetry(100)
