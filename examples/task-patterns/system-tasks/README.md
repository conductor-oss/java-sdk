...
Demonstrates INLINE and JSON_JQ_TRANSFORM system tasks. no workers needed. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
