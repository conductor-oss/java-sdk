...
Marketplace seller onboarding: register, verify, list products, manage orders. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers .  you write the business logic, Conductor handles retries, failure routing, durability, and observability for free.
...
Step 1: Registering task definitions...
  Registered: mkt_onboard_seller, mkt_verify_seller, mkt_list_products, mkt_manage_orders

Step 2: Registering workflow 'marketplace_seller_workflow'...
  Workflow registered.
...
Step 4: Starting workflow...
  ...
  [list] Listing products for store
  [orders] Order management activated for store
  [onboard] Registering seller
  [verify] Verifying documents for seller

  Status: COMPLETED
  Output: {productCount=..., products=..., active=..., fulfillmentMode=...}
...
conductor workflow start \
  ...
  --version 1 \
  --input '{"sellerId": "SELLER-4401", "SELLER-4401": "businessName", "businessName": "Handmade Goods Co.", "Handmade Goods Co.": "category", "category": "home_decor", "home_decor": "sample-home-decor"}'
```
