...
Auction workflow: open bidding, collect bids, close, determine winner, settle. Uses [Conductor](https://github.com/conductor-oss/conductor) to orchestrate independent services as workers.
