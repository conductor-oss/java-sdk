...
public class TestSerDerTextCompletion {
    ...
    public void testSerializationDeserialization() throws Exception {
        ...
        String SERVER_JSON = JsonTemplateSerDeserResolverUtil.getJsonString("TextCompletionV2");
        ...
        // Own fields
        assertTrue(textCompletion.isJsonOutput());
        assertEquals("sample_promptName", textCompletion.getPromptName());

        // Inherited fields from LLMWorkerInput
        assertEquals("sample_llmProvider", textCompletion.getLlmProvider());
        assertEquals("sample_model", textCompletion.getModel());
        assertEquals("sample_prompt", textCompletion.getPrompt());
        assertEquals(123.456, textCompletion.getTemperature(), 0.001);
        assertEquals(123.456, textCompletion.getTopP(), 0.001);
