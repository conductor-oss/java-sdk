...
public class TestSerDerPromptTemplateTestRequest {
    ...
    public void testSerializationDeserialization() throws Exception {
        // 1. Load the SERVER_JSON (reuse same template - shape unchanged)
        ...
        // Check numeric fields (now boxed Double)
        assertEquals(123.456, request.getTemperature(), 0.001);
        assertEquals(123.456, request.getTopP(), 0.001);
