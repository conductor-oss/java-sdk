...
public class TestSerDerStoreEmbeddingsInput {
    ...
    public void testSerializationDeserialization() throws Exception {
        ...
        String SERVER_JSON = JsonTemplateSerDeserResolverUtil.getJsonString("StoreEmbeddingsInputV2");
        ...
        // Check embedding fields (now on subclass, not parent)
        assertEquals("sample_embeddingModel", storeEmbeddingsInput.getEmbeddingModel());
        assertEquals("sample_embeddingModelProvider", storeEmbeddingsInput.getEmbeddingModelProvider());
        ...
        // Check inherited fields from LLMWorkerInput
        assertEquals("sample_llmProvider", storeEmbeddingsInput.getLlmProvider());
        assertEquals("sample_model", storeEmbeddingsInput.getModel());
